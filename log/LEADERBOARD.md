...
_Auto-generated 2026-09-09T09:36:54.426Z. Every row is a 1h window of real swaps; rake % = share of pool inflow that left through house cohorts (first-block, deployer-funded, lp, repeat). Full event log: [events.jsonl](./events.jsonl)._

| token | rake % | inflow | to the house | window end block |
|---|---:|---:|---:|---|
| STONKEX `0x5ab000ff…` | 300.6% | $5,884 | $17,689 | 51078611 |
| BASEJUICE `0xb2000000…` | 261.3% | $301 | $787 | 50862459 |
| VIBES `0xeffc8815…` | 146.2% | $6,313 | $9,231 | 50747782 |
| AERO `0x940181a9…` | 103% | $72,253 | $74,417 | 51078580 |
| KTA `0xc0634090…` | 92% | $6,130 | $5,639 | 50784749 |
| VELVET `0xbf927b84…` | 91.5% | $36,772 | $33,662 | 50674973 |
| VVV `0xacfe6019…` | 83.5% | $545,452 | $455,571 | 51078562 |
...
| Basecat `0xb2000000…` | 35.1% | $62,168 | $21,805 | 51078595 |

## Self-check - does a high rake predict anything?

Of 120 high-rake events (≥50%), **2%** were down ≥30% twelve hours later. Base rate across 271 low-rake events: **6%**. **In this sample, high rake did NOT predict drawdown better than baseline.** The receipts stand either way.
