...
_Auto-generated 2026-09-18T09:39:27.255Z. Every row is a 1h window of real swaps; rake % = share of pool inflow that left through house cohorts (first-block, deployer-funded, lp, repeat). Full event log: [events.jsonl](./events.jsonl)._
...
| LAPTOP `0xb0952747…` | 402.6% | $1,100 | $4,427 | 51467430 |
...
| KTA `0xc0634090…` | 101.8% | $487 | $495 | 51467475 |
...
Of 197 high-rake events (≥50%), **3%** were down ≥30% twelve hours later. Base rate across 474 low-rake events: **4%**. **In this sample, high rake did NOT predict drawdown better than baseline.** The receipts stand either way.
